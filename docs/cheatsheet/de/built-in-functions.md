---
title: 'Python-Integrierte Funktionen - Python Spickzettel'
description: 'Der Python-Interpreter verfügt über eine Reihe von Funktionen und Typen, die standardmäßig immer verfügbar sind.'
...
| <router-link to='/builtin/bin'>bin()</router-link>                   | Konvertiert eine Ganzzahl in eine binäre Zeichenkette.                                                                |
...
| <router-link to='/builtin/classmethod'>classmethod()</router-link>   | Wandelt eine Methode in eine Klassenmethode um.                                                                       |
...
| <router-link to='/builtin/hex'>hex()</router-link>                   | Konvertiert eine Ganzzahl in eine kleingeschriebene hexadezimale Zeichenkette.                                        |
...
| <router-link to='/builtin/list'>list()</router-link>                 | Ist eher ein veränderlicher Sequenztyp als eine Funktion.                                                             |
...
| <router-link to='/builtin/repr'>repr()</router-link>                 | Gibt eine Zeichenkette zurück, die eine druckbare Darstellung eines Objekts enthält.                                  |
| <router-link to='/builtin/reversed'>reversed()</router-link>         | Gibt einen umgekehrten Iterator zurück.                                                                               |
| <router-link to='/builtin/round'>round()</router-link>               | Gibt die auf ndigits Nachkommastellen gerundete Zahl zurück.                                                          |
...
| <router-link to='/builtin/staticmethod'>staticmethod()</router-link> | Wandelt eine Methode in eine statische Methode um.                                                                    |
