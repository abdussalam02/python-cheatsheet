...
description: 'El intérprete de Python tiene varias funciones y tipos integrados que siempre están disponibles.'
...
| <router-link to='/builtin/filter'>filter()</router-link>             | Construye un iterador a partir de un iterable y devuelve los elementos que son verdaderos. |
...
| <router-link to='/builtin/print'>print()</router-link>               | Imprime objetos en el archivo de flujo de texto.                                           |
...
| <router-link to='/builtin/import'>**import**()</router-link>         | Esta función es invocada por la declaración import.                                        |
